window.addEventListener("load", function(){
    ...
    form.addEventListener("submit", function(e){
        if(name.value == ""){
            ...
            name.style.color="red";
            nameE.hidden = false;
            nameE.innerHTML = "Nombre requerido";
            nameE.style.color ="red";
            }else{
                nameE.style.color ="black";
                nameE.hidden=true;
        ...
        if(cat.value == ""){
            errores.push("Categoria requerida");
            cat.style.borderColor="red";
            cat.style.color="red";
            catE.hidden = false;
            catE.innerHTML = "Categoria requerida";
            catE.style.color ="red";
            }else{
                catE.style.color ="black";
                catE.hidden=true;
        ...
        if(desc.value == ""){
            ...
            desc.style.color="red";
            descE.hidden = false;
            descE.innerHTML = "Descripción requerida";
            descE.style.color ="red";
            }else{
                descE.style.color ="black";
                descE.hidden=true;
        ...
        if(price.value == ""){
            ...
            price.style.color="red";
            priceE.hidden = false;
            priceE.innerHTML = "Precio requerido";
            priceE.style.color ="red";
            }else{
                priceE.style.color ="black";
                priceE.hidden=true;
        ...
        if(disc.value == ""){
            errores.push("Descuento requerido");
            disc.style.borderColor="red";
            disc.style.color="red";
            discE.hidden = false;
            discE.innerHTML = "Descuent requerido";
            discE.style.color ="red";
        }else{
                discE.style.color ="black";
                discE.hidden=true;
