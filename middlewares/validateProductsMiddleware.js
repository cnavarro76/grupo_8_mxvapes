...
body('nombre').notEmpty().withMessage('Nombre no puede estar vacío').bail()
.isLength({min: 5}).withMessage('El nombre debe tener al menos 5 caracteres'),
// body('id').notEmpty().withMessage('El ID no puede estar vacío'),
body('categoria').notEmpty().withMessage('Selecciona una categoría de producto'),
body('descripcion').notEmpty().withMessage('La  descripción no puede estar vacia').bail()
...
body('descuento').notEmpty().withMessage('El descuento no puede estar vacío'),
